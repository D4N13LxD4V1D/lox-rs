        ...
        match source[i] {
            ...
            'a'..='z' | 'A'..='Z' | '_' => {
                ...
                match literal.iter().collect::<String>().as_ref() {
                    ...
                    "null" => tokens.push(Token::new(TokenType::NIL, "null".to_string(), literal, line, word_index)),
                    ...
                    "let" => tokens.push(Token::new(TokenType::VAR, "let".to_string(), literal, line, word_index)),
